...
function SellerDashboard() {
    ...
    // Process province data for map
    const provinceData = {};
    reviewersByProvince.forEach(item => {
    ...
    const totalReviewers = reviewersByProvince.reduce((sum, p) => sum + (p.total || 0), 0);
            ...
            <main className={styles.mainContent}>
                ...
                <header className={styles.header}>
                    <div>
                        <h1 className={styles.pageTitle}>
                            {activeNav === 'dashboard' ? 'Dashboard' : 'Kelola Produk'}
                        </h1>
                ...
                <div className={styles.chartsRow}>
                    ...
                    <div className={styles.chartCard}>
                        ...
                        <ProductRatingList data={productRatings} />
                    </div>
                </div>
