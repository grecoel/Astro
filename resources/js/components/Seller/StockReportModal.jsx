...
export default function StockReportModal({ isOpen, onClose }) {
    ...
    const fetchReportData = async () => {
        try {
            ...
            const response = await axios.get('/api/seller/reports/stock/data', {
                headers: {
    ...
    const handleDownloadPdf = async () => {
        try {
            setDownloading(true);
            const token = localStorage.getItem('token');
            const response = await axios.get('/api/seller/reports/stock', {
                headers: {
                    'Authorization': `Bearer ${token}`
                },
                responseType: 'blob'
            ...
            link.href = url;
            link.setAttribute('download', `Laporan_Stok_${new Date().toISOString().split('T')[0]}.pdf`);
        ...
        <div className={styles.modalOverlay} onClick={onClose}>
            <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
                <div className={styles.modalHeader}>
                    <h2 className={styles.modalTitle}>Laporan Stok Produk</h2>
                        ...
                        <>
                            <div className={styles.reportHeader}>
                                <h2 className={styles.reportTitle}>
                                    Laporan Daftar Produk Berdasarkan Stock
                                </h2>
